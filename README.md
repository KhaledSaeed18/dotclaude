...
<div align="center">
<!-- badges:start -->
  <a href="#skills"><img src="https://shieldcn.dev/badge/Skills-35-2563eb.svg?split=true&logo=ri:RiSparkling2Fill" alt="35 skills" /></a>
...
| --- | --- | --- |
| **engineering** | Engineering workflow skills and review agents: planning, test-driven development, systematic debugging, code review, completion verification, and performance work. (14 skills, 6 agents, 1 command) | `/plugin install engineering@dotclaude` |
...
| **productivity** | Session productivity skills: collaborative brainstorming, plan stress-testing, session handoff documents, and a /prime command that loads project context. (3 skills, 2 commands) | `/plugin install productivity@dotclaude` |
