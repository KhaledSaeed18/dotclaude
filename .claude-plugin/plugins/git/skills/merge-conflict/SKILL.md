...
3. With the user's go-ahead, finalize using the operation's continue command from Step 1 (or `git commit` for a plain merge; keep the default merge message, and never add AI/co-author trailers).
